...
class RapiClientReadTestClazz extends RapiClientRead implements IRapiClientRead
{
    ...
    public function publicPrepareBrowseUrl(string $filterTerm, string $spaceKey = IRapiClientBase::REQ_VAL_SPACE_EMPTY): string
    {
        return $this->prepareBrowseUrl($filterTerm, $spaceKey);
    }

    public function publicPrepareScanUrl(string $spaceKey = IRapiClientBase::REQ_VAL_SPACE_EMPTY): string
    {
